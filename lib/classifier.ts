...
export const CANONICAL_MODELS = [
  ...
  'Runway', 'Kling', 'Pika', 'Luma', 'Hailuo', 'Sora', 'Veo', 'Aurora', 'Wan', 'Seedance',
...
Canonical models: Midjourney, DALL-E, Flux, Stable Diffusion, Firefly, Ideogram, Leonardo, Runway, Kling, Pika, Luma, Hailuo, Sora, Veo, Aurora, Wan, Seedance, Suno, Udio, ElevenLabs, ChatGPT, Claude, Nano Banana, Meshy, Tripo3D.
PLATFORM vs MODEL: When a tweet names a generation model AND a host/distribution platform (e.g. Higgsfield, Yapper, Flora, Medeo, PixVerse, Krea, Pixio, Magnific, Topview, Vadoo, Lart, OiiOii, CapCut, InVideo, ImagineArt, Sketch AI, nsketchai, Martini), pick the generation model — never the platform. Examples: "Made with Seedance 2 on @higgsfield" → Seedance. "Created on @yapper_so using Veo 3" → Veo. "#Seedance2 @PixVerse_" → Seedance.
COMPARISONS: When the prompt itself was generated by one model but the tweet mentions others for comparison ("I tested X vs Y"), pick the model that actually produced the shown prompt/output, not the comparison target.
