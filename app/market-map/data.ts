...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    color: '#0ea5e9',
    companies: [
      { name: 'CapCut / Dreamina', kind: 'incumbent', modelDependency: 'own-models', domain: 'capcut.com', thesis: 'Durable — the largest creation funnel on earth feeds its own model', note: 'Seedance 2.5 (public Jul 31) into a 400M-MAU editor', momentum: true, facts: { users: '400M+ MAU (a16z est. ~736M)', asOf: 'Mar 2026' } },
      ...
      { name: 'Meta Vibes', kind: 'incumbent', modelDependency: 'own-models', domain: 'meta.com', thesis: 'Fragile — AI feeds need creators, not prompts', note: '~2M DAU, weak retention; the surviving-but-limping AI feed', facts: { users: '~2M DAU, declining', asOf: 'Nov 2025' } },
    ],
  },
  {
    id: 'music-audio',
  ...
  },
  {
    ...
    companies: [
      ...
      { name: 'Vercel AI Gateway', kind: 'incumbent', modelDependency: 'multi-model', domain: 'vercel.com', thesis: 'Unproven — gateways commoditize routing from above', note: '32 image + 30 video models; gateways treat media as first-class now', facts: { valuation: 'Vercel $9.3B (parent)', users: '200K+ teams (claimed)', asOf: 'Jul 2026' } },
