...
export const CATEGORIES: Category[] = [
  {
    ...
    color: '#8b5cf6',
    companies: [
      { name: 'Canva', kind: 'incumbent', modelDependency: 'multi-model', domain: 'canva.com', thesis: 'Durable — 265M users make models interchangeable inputs', note: 'Leonardo models + third-party shelf; Affinity now free', facts: { arr: '~$4B+ ARR', users: '265M MAU', asOf: 'Aug 2026' }, momentum: true },
  ...
  },
  {
    ...
    companies: [
      ...
      { name: 'Creatify', kind: 'startup', modelDependency: 'multi-model', domain: 'creatify.ai', thesis: 'Unproven — the 15M-ad corpus is real; platform absorption risk is too', note: 'Creatify Agent (May 2026) trained on 15M+ ads; locked brand facts as constraints' },
      { name: 'Typeface', kind: 'startup', modelDependency: 'partner-models', domain: 'typeface.ai', thesis: 'Unproven — brand governance sells; suite bundling squeezes', note: 'Enterprise brand governance, Arc Agents' },
      { name: 'Jasper', kind: 'startup', modelDependency: 'partner-models', domain: 'jasper.ai', thesis: 'Unproven — enterprise base real, differentiation thinning', note: '900+ enterprise customers; GEO Agent (Jun 2026)' },
      ...
      { name: 'Photoroom', kind: 'startup', modelDependency: 'own-models', domain: 'photoroom.com', thesis: 'Fragile — free platform tools are eating product imagery', note: 'Product imagery leader; squeezed by free platform tools' },
      { name: 'Pencil (Brandtech)', kind: 'incumbent', modelDependency: 'multi-model', domain: 'trypencil.com', thesis: 'Fragile — agency economics cap the upside', note: 'Agency-embedded enterprise creative gen' },
      { name: 'Smartly', kind: 'incumbent', modelDependency: 'multi-model', domain: 'smartly.io', thesis: 'Unproven — adtech incumbents absorb the agent pattern', note: 'Synapse orchestration layer (Jun 2026) — adtech incumbents absorbing the agent pattern' },
    ],
  },
  {
    id: 'film-video',
    ...
    companies: [
      ...
      { name: 'Moonvalley', kind: 'startup', modelDependency: 'own-models', domain: 'moonvalley.ai', thesis: 'Durable — provenance is what studio procurement actually buys', note: 'Marey trained exclusively on licensed data — the clean-model studio wedge' },
      { name: 'LTX Studio (Lightricks)', kind: 'startup', modelDependency: 'open-weights', domain: 'ltx.studio', thesis: 'Durable — the Linux-of-video position compounds', note: 'Open-sourced LTX-2 (Jan 2026); script-to-screen pipeline + own open models', momentum: true },
      ...
      { name: 'Autodesk Flow Studio', kind: 'incumbent', modelDependency: 'own-models', domain: 'autodesk.com', thesis: 'Unproven — strategic buyer more than standalone winner', note: 'ex-Wonder Dynamics video→CG; $200M into World Labs' },
      { name: 'Promise', kind: 'startup', modelDependency: 'multi-model', domain: 'promisestudios.com', thesis: 'Unproven — AI-native studio thesis unproven at feature length', note: 'AI-native studio; a16z, Google AI Futures Fund, Crossbeam' },
      { name: 'Flawless', kind: 'startup', modelDependency: 'own-models', domain: 'flawlessai.com', thesis: 'Unproven — consent-based dubbing is defensible but narrow', note: 'Consent-based visual dubbing for studios' },
      { name: 'Deepdub', kind: 'startup', modelDependency: 'own-models', domain: 'deepdub.ai', thesis: 'Unproven — royalty model aligns talent; scale unproven', note: 'Production dubbing with voice-clone royalties' },
    ],
  },
  {
    id: 'social-ugc',
    ...
    color: '#0ea5e9',
    companies: [
      { name: 'CapCut / Dreamina', kind: 'incumbent', modelDependency: 'own-models', domain: 'capcut.com', thesis: 'Durable — the largest creation funnel on earth feeds its own model', note: 'Seedance 2.5 (public Jul 31) into a 400M-MAU editor', momentum: true },
      { name: 'YouTube Shorts + Veo', kind: 'incumbent', modelDependency: 'own-models', domain: 'youtube.com', thesis: 'Durable — free frontier video in the feed ends standalone apps', note: 'Free frontier video gen inside the feed — the biggest distribution event in GenMedia' },
      { name: 'Grok Imagine', kind: 'lab', modelDependency: 'own-models', domain: 'x.ai', thesis: 'Unproven — arena wins and X distribution; retention unproven', note: '#1 on video arenas in early 2026 at ~$4.20/min; Image 2.0 slipped to Arena #3 in image (MAI-2.6 took #2) but holds #2 in image-edit; X distribution' },
      { name: 'Higgsfield', kind: 'startup', modelDependency: 'multi-model', domain: 'higgsfield.ai', thesis: 'Unproven — $5.4B priced on claimed revenue; Soul ID is the test', note: 'Soul ID character persistence is the moat; revenue figures company-claimed, not audited', facts: { valuation: '$5.4B', raised: '$400M Series B', arr: '$700M annualized (claimed)', asOf: 'Aug 2026', cite: '40' }, momentum: true },
      { name: 'PixVerse', kind: 'startup', modelDependency: 'own-models', domain: 'pixverse.ai', thesis: 'Unproven — consumer export machine with opaque unit economics', note: 'Real-time R1 model', facts: { valuation: 'over $2B', raised: '$439M', users: '150M users (claimed)', asOf: 'Jul 2026', cite: '25' }, momentum: true },
      ...
      { name: 'Viggle', kind: 'startup', modelDependency: 'own-models', domain: 'viggle.ai', thesis: 'Unproven — meme engine with feature-absorption risk', note: 'Physics-aware character motion; meme-format engine' },
      { name: 'Character.AI', kind: 'startup', modelDependency: 'own-models', domain: 'character.ai', thesis: 'Unproven — engagement is real; monetization is not yet', note: 'Chat → feed → AvatarFX video arc' },
      { name: 'Meta Vibes', kind: 'incumbent', modelDependency: 'own-models', domain: 'meta.com', thesis: 'Fragile — AI feeds need creators, not prompts', note: '~2M DAU, weak retention; the surviving-but-limping AI feed' },
    ],
  },
  {
    id: 'music-audio',
    ...
    color: '#10b981',
    companies: [
      { name: 'ElevenLabs', kind: 'startup', modelDependency: 'own-models', domain: 'elevenlabs.io', thesis: 'Durable — the cleanest scale-up in GenMedia; licensed-first compounds', note: 'Voice → dubbing → agents → licensed music', facts: { valuation: '$11B', arr: '~$500M ARR (est.)', asOf: 'Apr 2026', cite: '6' }, momentum: true },
      { name: 'Suno', kind: 'startup', modelDependency: 'own-models', domain: 'suno.com', thesis: 'Durable — WMG/BMG deals de-risked the model; UMG still looms', note: 'Settled WMG (Nov 2025) and BMG (Aug 2026) from strength; UMG suit live, Sony ruling not before 2027', facts: { valuation: '$5.4B', raised: '$400M', arr: '~$300M ARR (est.)', asOf: 'Jun 2026', cite: '7' }, momentum: true },
      { name: 'Udio', kind: 'startup', modelDependency: 'own-models', domain: 'udio.com', thesis: 'Fragile — label-captured; upside flows to UMG/WMG', note: 'Absorbed into a UMG/WMG walled garden — the labels captured it' },
      { name: 'Cartesia', kind: 'startup', modelDependency: 'own-models', domain: 'cartesia.ai', thesis: 'Durable — latency is a constraint the frontier ignores', note: 'Sonic 3.6 (Aug 18) leads both AA speech arenas; sub-100ms vendor-claimed TTFA' },
      { name: 'KLAY', kind: 'startup', modelDependency: 'own-models', domain: 'klay.vision', thesis: 'Unproven — three-major licensing; product still early', note: 'First AI music co licensed by all three majors' },
      { name: 'Descript', kind: 'startup', modelDependency: 'multi-model', domain: 'descript.com', thesis: 'Unproven — right agent bet, crowded editor field', note: 'Underlord agentic editor is now the product center' },
      ...
      { name: 'Stability Audio', kind: 'startup', modelDependency: 'own-models', domain: 'stability.ai', thesis: 'Fragile — survival pivot in a licensed-catalog game', note: 'Survival-mode audio pivot; UMG partnership post-Udio' },
    ],
  },
  {
    id: 'gaming-3d-worlds',
    ...
    companies: [
      ...
      { name: 'Decart', kind: 'startup', modelDependency: 'own-models', domain: 'decart.ai', thesis: 'Durable — the optimization stack is worth more than the demos', note: 'Sub-35ms real-time; Anthropic acquisition reported near signing at ~$7B, mostly stock, NVIDIA outbid (Aug 16 — still unsigned)', facts: { valuation: '~$4B', raised: '$300M', asOf: 'Aug 2026', cite: '48' }, momentum: true },
      ...
      { name: 'NVIDIA Cosmos', kind: 'incumbent', modelDependency: 'open-weights', domain: 'nvidia.com', thesis: 'Durable — arming everyone beats betting on anyone', note: 'Cosmos 3 open omnimodel + Coalition (BFL, Runway, LTX) — Llama-izing world models' },
      ...
      { name: 'Meshy', kind: 'startup', modelDependency: 'own-models', domain: 'meshy.ai', thesis: 'Fragile — priced on optionality at roughly 50x ARR', note: 'Priced on world-model optionality; 12x YoY growth claimed', facts: { valuation: '$1.5B', raised: '~$400M Series B', arr: '~$30M ARR', asOf: 'Jul 2026', cite: '33' } },
      ...
      { name: 'Rodin (Deemos)', kind: 'startup', modelDependency: 'own-models', domain: 'deemos.com', thesis: 'Unproven — sub-$1 pricing proves the commodity endgame', note: 'Lowe’s 30k-item catalog at <$1/model — 3D pricing already commoditized', facts: { raised: 'CNY 100Ms round (Jun 2026)', investors: ['Cathay Capital', 'Shanghai SSCI'], asOf: 'Jun 2026' } },
      ...
      { name: 'Scenario', kind: 'startup', modelDependency: 'multi-model', domain: 'scenario.com', thesis: 'Fragile — style-lock is becoming a frontier-model feature', note: 'Style-locked game assets; thin moat vs frontier models', facts: { raised: '$11M', asOf: 'Jan 2023' } },
  ...
  },
  {
    ...
    companies: [
      ...
      { name: 'HeyGen', kind: 'startup', modelDependency: 'multi-model', domain: 'heygen.com', thesis: 'Durable — the capital-efficiency benchmark of the app layer', note: 'Cash-flow break-even; burned only $25M of the $74M raised', facts: { arr: '$200M ARR', raised: '~$74M total', asOf: 'Jun 2026', cite: '8' }, momentum: true },
      ...
      { name: 'Gemini Notebook', kind: 'incumbent', modelDependency: 'own-models', domain: 'google.com', thesis: 'Durable — free doc-to-video caps the category', note: 'ex-NotebookLM, 30M users; free doc→video caps the explainer category' },
      { name: 'Tavus', kind: 'startup', modelDependency: 'own-models', domain: 'tavus.io', thesis: 'Unproven — real-time niche defensible; TAM question open', note: 'Real-time conversational avatars, <500ms end-to-end', facts: { valuation: '~$250M (secondary est.)', raised: '$64M', investors: ['CRV', 'Sequoia', 'Scale Venture Partners'], asOf: 'Aug 2026' } },
  ...
  },
  {
    ...
    color: '#ec4899',
    companies: [
      { name: 'fal', kind: 'startup', modelDependency: 'multi-model', domain: 'fal.ai', thesis: 'Durable — media-native inference compounds; agents extend margin', note: 'Launched fal Agent Aug 2026; ~$8B round in talks since Mar, unclosed', facts: { valuation: '$4.5B', arr: '~$400M annualized', asOf: 'Mar 2026', cite: '10' }, momentum: true },
      ...
      { name: 'Flora', kind: 'startup', modelDependency: 'multi-model', domain: 'florafauna.ai', thesis: 'Unproven — FAUNA plus marquee logos; needs enterprise state', note: 'FAUNA agent wires node pipelines from a brief; Nike/Netflix/Lionsgate', facts: { raised: '$42M Series A', asOf: 'Jan 2026', cite: '14' } },
      ...
      { name: 'WaveSpeed', kind: 'startup', modelDependency: 'multi-model', domain: 'wavespeed.ai', thesis: 'Unproven — fastest Western shelf for Chinese models; fragile edge', note: 'Fastest Western access to Chinese models' },
      { name: 'Vercel AI Gateway', kind: 'incumbent', modelDependency: 'multi-model', domain: 'vercel.com', thesis: 'Unproven — gateways commoditize routing from above', note: '32 image + 30 video models; gateways treat media as first-class now', facts: { users: '200K+ teams (claimed)', asOf: 'Jul 2026' } },
...
export const MOAT_MATRIX: MatrixRow[] = [
  ...
  },
  {
    ...
    leverage: 'OpenAI at the frontier; BFL via platform licensing; margins thin below the top',
  },
  {
    layer: 'Audio / voice / music',
    differentiation: 'High — licensed catalogs, latency, enterprise trust',
    risk: 'low',
    durability: 'Label deals are legally enforceable; owned models keep COGS low',
    leverage: 'Best economics in GenMedia — ElevenLabs, Suno, Synthesia-class margins',
  },
  {
    layer: 'Thin generation apps',
    differentiation: 'Minimal — same model shelf as everyone else',
    risk: 'high',
    durability: 'None; 40–50% of revenue goes to model COGS',
    leverage: 'Squeezed from both sides; consolidation and shutdowns (Icon, Visual Electric)',
  },
  {
  ...
  },
  {
    ...
    risk: 'medium',
    durability: 'Hand-built optimization (no open standard exists); usage pricing',
  ...
  },
  {
    ...
    leverage: 'Landlord economics — high capture, high capex',
  },
  {
