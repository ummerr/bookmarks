...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    companies: [
      ...
      { name: 'Pencil (Brandtech)', kind: 'incumbent', modelDependency: 'multi-model', domain: 'trypencil.com', thesis: 'Fragile — agency-embedded delivery limits how far the product scales', note: 'Agency-embedded enterprise creative gen' },
  ...
  },
  {
    ...
    companies: [
      ...
      { name: 'Suno', kind: 'startup', modelDependency: 'own-models', domain: 'suno.com', thesis: 'Durable — WMG/BMG licenses turned legal risk into catalog access; UMG looms', note: 'Settled WMG (Nov 2025) and BMG (Aug 2026) from strength; UMG suit live, Sony ruling not before 2027', facts: { valuation: '$5.4B', raised: '$400M', arr: '~$300M ARR (est.)', asOf: 'Jun 2026', cite: '7' }, momentum: true },
      { name: 'Udio', kind: 'startup', modelDependency: 'own-models', domain: 'udio.com', thesis: 'Fragile — label-captured; roadmap and terms now set by UMG/WMG', note: 'Absorbed into a UMG/WMG walled garden — the labels captured it' },
      ...
      { name: 'Descript', kind: 'startup', modelDependency: 'multi-model', domain: 'descript.com', thesis: 'Unproven — right agent direction, crowded editor field', note: 'Underlord agentic editor is now the product center' },
  ...
  },
  {
    ...
    companies: [
      ...
      { name: 'NVIDIA Cosmos', kind: 'incumbent', modelDependency: 'open-weights', domain: 'nvidia.com', thesis: 'Durable — supplying every builder beats depending on any one lab', note: 'Cosmos 3 open omnimodel + Coalition (BFL, Runway, LTX) — Llama-izing world models' },
      ...
      { name: 'Scenario', kind: 'startup', modelDependency: 'multi-model', domain: 'scenario.com', thesis: 'Fragile — style-lock is becoming a frontier-model feature', note: 'Style-locked game assets; little holds once frontier models ship the same control', facts: { raised: '$11M', asOf: 'Jan 2023' } },
...
export const MODEL_GROUPS: ModelGroup[] = [
  ...
  {
    modality: 'Image',
    note: 'The closest thing to a stable frontier: GPT Image 2 holds #1 on every arena (1368–1463 Elo across boards), but MAI-Image-2.6’s Aug 10 debut at Arena #2 cut the text-to-image lead to 45 Elo — a real capability lead, but no longer a widening one.',
    entries: [
...
export const MOMENTUM: MomentumEntry[] = [
  ...
  { rank: 8, name: 'Suno', what: 'music', domain: 'suno.com', why: '$400M at $5.4B raised mid-lawsuit; settled with WMG and BMG from a position of strength — licensing is turning its biggest legal risk into its most durable advantage, with UMG still litigating.' },
  ...
  { rank: 14, name: 'Decart', what: 'real-time inference', domain: 'decart.ai', why: 'Sub-35ms real-time generation, $300M at ~$4B, and an Anthropic acquisition reported near signing at ~$7B (mostly stock, NVIDIA outbid) — external capital registering what a hand-built optimization stack is worth.' },
