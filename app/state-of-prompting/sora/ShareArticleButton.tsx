...
const URL = 'https://prompts.ummerr.com/state-of-prompting/sora'
const TITLE = 'Why Sora Shut Down'
const TWEET = 'Why Sora shut down: $15M/day inference costs, $2.1M lifetime revenue, 1% retention'
